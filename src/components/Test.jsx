                            ...
                            <div class="row">
                                ...
                                <div class=" col-lg-4 col-md-6 mb-4">
                                    <div class="bg-light rounded shadow-lg">
                                        ...
                                        <a href="#gallery"><img src="img1.jpg" onClick={() => { setPopIndex(1) }} data-bs-toggle="modal" data-bs-target="#testModal" alt="" class="img-fluid card-img-top" /></a>
                                        <div class="p-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="bg-light rounded shadow-lg">
                                        <a href="#gallery"><img src="img1.jpg" onClick={() => { setPopIndex(2) }} data-bs-toggle="modal" data-bs-target="#testModal" alt="" class="img-fluid card-img-top" /></a>
                                        <div class="p-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="bg-light rounded shadow-lg">
                                        <a href="#gallery"><img src="img1.jpg" onClick={() => { setPopIndex(3) }} data-bs-toggle="modal" data-bs-target="#testModal" alt="" class="img-fluid card-img-top" /></a>
                                        <div class="p-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="bg-light rounded shadow-lg">
                                        <a href="#gallery"><img src="img1.jpg" onClick={() => { setPopIndex(4) }} data-bs-toggle="modal" data-bs-target="#testModal" alt="" class="img-fluid card-img-top" /></a>
                                        <div class="p-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="bg-light rounded shadow-lg">
                                        <a href="#gallery"><img src="img1.jpg" onClick={() => { setPopIndex(5) }} data-bs-toggle="modal" data-bs-target="#testModal" alt="" class="img-fluid card-img-top" /></a>
                                        <div class="p-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="bg-light rounded shadow-lg">
                                        <a href="#gallery"><img src="img1.jpg" onClick={() => { setPopIndex(6) }} data-bs-toggle="modal" data-bs-target="#testModal" alt="" class="img-fluid card-img-top" /></a>
                                        <div class="p-4">

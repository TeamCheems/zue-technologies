                            ...
                            <div className="col-lg-4 col-md-12 mb-4">
                                ...
                                <div className="modal-dialog modal-lg" role="document">
                                    ...
                                    <div className="modal-body mb-0 p-0">
                                        ...
                                        <div className="embed-responsive embed-responsive-16by9 z-depth-1-half">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/GUEZCxBcM78"
                                            allowfullscreen></iframe>
                                        </div>
                                ...
                                <a><img className="img-fluid z-depth-1" src="https://mdbootstrap.com/img/screens/yt/screen-video-4.jpg" alt="video"
                            ...
                            <div className="col-lg-4 col-md-6 mb-4">
                                ...
                                <div className="modal-dialog modal-lg" role="document">
                                    ...
                                    <div className="modal-body mb-0 p-0">
                                        ...
                                        <div className="embed-responsive embed-responsive-16by9 z-depth-1-half">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/PjGkVCAo8Fw"
                                            allowfullscreen></iframe>
                                        </div>
                                ...
                                <a><img className="img-fluid z-depth-1" src="https://mdbootstrap.com/img/screens/yt/screen-video-5.jpg" alt="video"
                            ...
                            <div className="col-lg-4 col-md-6 mb-4">
                                ...
                                <div className="modal-dialog modal-lg" role="document">
                                    ...
                                    <div className="modal-body mb-0 p-0">
                                        ...
                                        <div className="embed-responsive embed-responsive-16by9 z-depth-1-half">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/gsNY7TV4r1M"
                                            allowfullscreen></iframe>
                                        </div>
                                    ...
                                    {/* <!--Footer--> */}
                                    <div className="modal-footer d-block d-md-flex justify-content-center">
                                        <span className="mr-4">Spread the word!</span>
                                        <a type="button" className="btn-floating btn-sm btn-fb"><i className="fab fa-facebook-f"></i></a>
                                        {/* <!--Twitter--> */}
                                        <a type="button" className="btn-floating btn-sm btn-tw"><i className="fab fa-twitter"></i></a>
                                ...
                                <a><img className="img-fluid z-depth-1" src="https://mdbootstrap.com/img/screens/yt/screen-video-6.jpg" alt="video"

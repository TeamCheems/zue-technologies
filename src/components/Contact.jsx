                ...
                <h1>Contact</h1>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-4 justify-content-center flex-column text-justify">
                            <h6><FontAwesomeIcon icon={faBuilding} /><i class="fa fa-building mx-2"></i>Zue Technologies</h6>
                            <p class="text-justify">Build your Ideas.</p>
                        </div>

                        <div class="col-lg-4 col-md-6 mb-4 justify-content-center flex-column text-justify">
                            <h6><FontAwesomeIcon icon={faPhoneAlt} /><i class="fa fa-phonealt mx-2"></i>Phone</h6>
                            <p>8870795518</p>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4 justify-content-center flex-column text-justify">
                        <h6><FontAwesomeIcon icon={faEnvelope} /><i class="fa fa-envelope mx-2"></i>Email</h6>
                            <p>zuetechnologies@gmail.com</p>
                            </div>  
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-4 justify-content-center flex-column text-justify">
                        <h6><FontAwesomeIcon icon={faAddressCard} /><i class="fa fa-addresscard mx-2"></i>Address</h6>
                            <p>9B, Anboli Nagar,</p> 
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 justify-content-center flex-column text-justify">
                        <h6><FontAwesomeIcon icon={faMapMarkerAlt} /><i class="fa fa-mapmakeralt mx-2"></i>Location</h6>
                        <div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 justify-content-center flex-column text-justify">
                        <h6><FontAwesomeIcon icon={faPlus} /><i class="fa fa-plus mx-2"></i>Follow us</h6><br/>
